...
const extractKeywords = async(question)=> {
  ...
  console.log("this is the keywords!")
  ...
  console.log('tokens after pregmathed')
  console.log(tokens)
  ...
  tokens.forEach((keyword) => {
    ...
    console.log('this is the phraseKeywords')
    const filteredKeywords = phraseKeywords.filter(keyword => keyword.trim() !== '');
    console.log(filteredKeywords)
    processedKeywords.push(...filteredKeywords);
  });
  // orginal
  ...
  .filter(token => !stopwords.includes(token.toLowerCase()) && !customWords.includes(token.toLowerCase()))
  .join(' ');
  console.log('this is the filteredTokens')
  console.log(filteredTokens)
  const keywordsObject = {};
 //convert the string into array
 const filteredTokensSpace = [filteredTokens]
 console.log('this is filteredTokensSpace')
 console.log(filteredTokensSpace)

 filteredTokensSpace.forEach((token, k) => {
          ...
          for (const row of record.data) {
            ...
            for (const key of keys) {
              ...
              if (key.toLowerCase().includes(token.toLowerCase()) || value.toLowerCase().includes(token.toLowerCase())) {
               console.log('this is icludes searching')
