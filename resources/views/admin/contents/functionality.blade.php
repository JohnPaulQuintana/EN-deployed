                                            ...
                                            <td>
                                                <div class="card" style="width: 10rem; margin:auto;">
                                                    ...
                                                    <div class="card-body">
                                                        ...
                                                        @endphp
                                                        <button type="button" class="btn {{ $className }} form-control btn-system" data-action="{{ optional($systems[0])->status  }}" data-id="{{ optional($systems[0])->id }}">{{ $text }}</button>
                                                      {{-- <p class="card-text">Some quick example text to build on the card title and make up the bulk of the card's content.</p> --}}
                                                    </div>
                                                  </div>
                                            </td>
